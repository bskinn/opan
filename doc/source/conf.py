# -*- coding: utf-8 -*-
#
# opan documentation build configuration file, created by
...
latex_documents = [
  (master_doc, 'opan.tex', u'opan Documentation',
   u'Brian Skinn', 'manual'),
]
...
man_pages = [
    (master_doc, 'opan', u'opan Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'opan', u'opan Documentation',
   author, 'opan', 'One line description of project.',
   'Miscellaneous'),
]
