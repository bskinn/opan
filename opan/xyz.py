...
class OpanXYZ(object):
    ...
    **Bohrs**.
    ...
    will almost certainly cause semantic difficulties in downstream code.

    For reference, in |orca| '.xyz' files contain the highest
    ...
    **Instance Variables**
    ...
    .. attribute:: num_atoms
        ...
        |int|_ -- Number of atoms per geometry, N

    .. attribute:: num_geoms

        |int|_ -- Number of geometries, G
    ...
    **Generators**
    ...
    def _load_data(self, atom_syms, coords, bohrs=True):
        ...
        atom_syms   : squeezes to array of N strings
            ...
            .const.atom_num.keys()
        coords      : squeezes to array of 3N |npfloat|_ castables
